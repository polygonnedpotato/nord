...
class RES{
  public:
    ...
    const string scn_05[2]={"\e[36m[?]Oh thank god you're okay! For a moment there I thought you were going to be the newest fatality by \e[1mthe sweep\e[22m!\n\e[0m","[1]"};
...
void saveNow(){
  try{
    ...
    sf<<chkpnt
    sf.close();
    cout<<obj.game_dat[10];
  }
  catch(...){
    cerr<<obj.game_dat[11];
  }
}
void loadSave(){
  try{
...
void printScene(int scn){
  ...
  switch(scn){
    ...
    case 3: //03
      ...
      break;
    case 4: //04
      cout<<obj.scn_04[0]<<obj.game_dat[0]<<obj.scn_04[1]<<obj.game_dat[9];
      break;
    default:
      cerr<<obj.game_dat[2];
      exit(1);
